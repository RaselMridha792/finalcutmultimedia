...
export default function OurWork() {
  ...
  return (
    <section className="w-full bg-[#0A0A0A] py-[12vh] px-[5vw] font-['Segoe_UI',Arial,sans-serif]">
      ...
      {/* Works Grid */}
      <div className="max-w-[90vw] md:max-w-[85vw] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[4vw] md:gap-[2.5vw]">
        {works.map((work) => (
          <Link 
            href="/gallery" 
            key={work.id} 
