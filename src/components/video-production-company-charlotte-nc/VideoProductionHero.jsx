...
import { FiArrowRight } from "react-icons/fi"; // বাটন আইকনের জন্য

export default function VideoProductionHero() {
  return (
    <section className="relative w-full min-h-[100vh] flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        <Image
          ...
          unoptimized
        />
        {/* ডার্ক থিমের জন্য ব্ল্যাক ওভারলে */}
      ...
      {/* কন্টেন্ট কন্টেইনার (২ কলাম লেআউট) */}
      <div className="relative z-10 w-full max-w-[90vw] mx-auto flex flex-col md:flex-row items-center justify-between gap-[8vw] md:gap-[4vw] pt-[15vh]">
        ...
        <div className="w-full md:w-[45%] relative flex justify-center items-center mt-[8vh] md:mt-0 mb-[5vh] md:mb-0">
          ...
          {/* ড্রোন ইমেজ (ফ্লোটিং অ্যানিমেশন সহ) */}
      ...
      {/* কাস্টম CSS (ড্রোনের ফ্লোটিং অ্যানিমেশনের জন্য) */}
